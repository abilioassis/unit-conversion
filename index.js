...
const ftValElm = document.getElementById("ft-val");
// Volume (Liters/Gallons)
const lValElm = document.getElementById("l-val");
const galValElm = document.getElementById("gal-val");
// Mass (Kilograms/Pounds)
const kgValElm = document.getElementById("kg-val");
const lbValElm = document.getElementById("lb-val");
